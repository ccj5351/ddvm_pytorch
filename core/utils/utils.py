...
>>>>>>> cc5331c9f291339d1c66b287d2b906d7074c5888
...
def backwarp(tenInput, tenFlow):
    ...
    grid = torch.cat([tenHorizontal, tenVertical], 1).to(tenInput.device) + tenFlow
    grid = grid.permute(0, 2, 3, 1) #[B,2,H,W] --> [B,H,W,2]
    return F.grid_sample(input=tenInput, grid = grid, mode='bilinear', 
                         padding_mode='border', 
                         align_corners=True
                         )
