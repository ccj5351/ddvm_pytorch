    ...
    def __init__(
        ...
        self.init_conv = CrossEmbedLayer(init_channels, dim_out=init_dim, 
                                         ...
                                         stride = 1) if init_cross_embed else nn.Conv2d(
                                             init_channels, init_dim, init_conv_kernel_size,
        ...
        # for non-attention based text conditioning at all points in
        # the network where time is also conditioned
        ...
        # whether to combine feature maps from all upsample blocks 
        # before final resnet block out
